...
User.register_custom_field_type('autoresponder_start_time', :time)
User.register_custom_field_type('autoresponder_end_date', :date)
User.register_custom_field_type('autoresponder_end_time', :time)
...
public_user_custom_fields.push('autoresponder_start_time')
public_user_custom_fields.push('autoresponder_end_date')
public_user_custom_fields.push('autoresponder_end_time')
